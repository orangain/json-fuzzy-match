...
class ArrayMarkerTest {
    ...
    fun doesNotMatchNullField() {
        Assertions.assertThatThrownBy {
            ...
            .hasMessageContaining("""path: $.a, actual: null, expected: "#array", reason: not an array""")
    }
    ...
    fun doesNotMatchBoolean() {
        Assertions.assertThatThrownBy {
            ...
            .hasMessageContaining("""path: $.a, actual: true, expected: "#array", reason: not an array""")
    }
    ...
    fun doesNotMatchNumber() {
        Assertions.assertThatThrownBy {
            ...
            .hasMessageContaining("""path: $.a, actual: 1, expected: "#array", reason: not an array""")
    }
    ...
    fun doesNotMatchObject() {
        Assertions.assertThatThrownBy {
            ...
            .hasMessageContaining("""path: $.a, actual: {}, expected: "#array", reason: not an array""")
    }
}